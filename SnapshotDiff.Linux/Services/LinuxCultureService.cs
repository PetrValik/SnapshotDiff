...
/// <summary>
/// Linux culture service. Applies CultureInfo on current thread and notifies CultureState.
/// </summary>
public sealed class LinuxCultureService(CultureState cultureState) : ICultureService
{
